...
const getIsWebContainer = () =>
  process.env.NEXT_PUBLIC_ENV_MODE === "webcontainer";
  ...
  persist(
    (set) => ({
      ...
      login: (userData) => {
        ...
        const roles = getIsWebContainer()
          ? (["homeowner", "contractor"] as UserRole[])
          : userData.roles;
    ...
    user: getIsWebContainer()
      ...
      : auth0User
        ? {
            ...
            roles: (auth0User["https://myapp.org/roles"] as UserRole[]) || [
              "homeowner",
            ],
            activeRole:
              (auth0User["https://myapp.org/activeRole"] as UserRole) ||
              "homeowner",
          }
        : null,
