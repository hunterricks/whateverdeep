// File: /Users/hunterricks/Downloads/stackblitz-starters-3acn8s (7)/app/api/account/delete/route.ts
// skipcq: JS-C1003
...
type TEntry =
  typeof import("../../../../../../app/api/account/delete/route.js");
...
if ("DELETE" in entry) {
  checkFields<
    Diff<
      ParamCheck<Request | NextRequest>,
      {
        __tag__: "DELETE";
        __param_position__: "first";
        __param_type__: FirstArg<MaybeField<TEntry, "DELETE">> extends
          | NextRequest
          | Request
  ...
  checkFields<
    Diff<
      {
        __tag__: "DELETE";
        __return_type__: Response | undefined | Promise<Response | undefined>;
      },
      {
        __tag__: "DELETE";
    ...
    Diff<
      {
        ...
        __return_type__: unknown[] | Promise<unknown[]>;
      },
      {
        __tag__: "generateStaticParams";
