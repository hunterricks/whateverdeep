...
type Diff<Base, T extends Base, Message extends string = ""> = 0 extends 1 & T
  ? NonNullable<unknown>
  : OmitWithTag<T, Extract<keyof Base, string>, Message>;

type FirstArg<T> = T extends (arg1: infer U, ...args: unknown[]) => unknown
  ? U
  : never;
type SecondArg<T extends (...args: any[]) => any> = T extends (
