  ...
  checkFields<
    Diff<
      ParamCheck<PageParams>,
      {
        ...
        __param_type__: SecondArg<MaybeField<TEntry, "GET">> extends PageParams
          ? SecondArg<MaybeField<TEntry, "GET">>
          : never;
      },
      "GET"
    >
...
type FirstArg<T extends (...args: any[]) => any> = T extends (
  ...
  ? unknown extends U
    ...
    : U
  : never;
type SecondArg<T extends (...args: any[]) => unknown> = T extends (
